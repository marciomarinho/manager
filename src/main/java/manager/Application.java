...
public class Application implements CommandLineRunner {
    ...
    public void run(String... strings) throws Exception {
        ...
        Sprint sp1 =  new Sprint(0,"Sprint1", LocalDate.of(2015, 11, 01), LocalDate.of(2015, 11, 30), project1);
        Sprint sp2 =  new Sprint(0,"Sprint2", LocalDate.of(2015, 12, 01), LocalDate.of(2015, 12, 31), project1);
        Sprint sp3 =  new Sprint(0,"Sprint3", LocalDate.of(2016, 01, 01), LocalDate.of(2016, 04, 12), project1);
